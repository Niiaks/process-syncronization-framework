...
/**
 * Example demonstrating the use of a Semaphore as a monitor.
 * Allows up to 2 threads to enter the critical section concurrently.
 */
public class MonitorExample {
    ...
    /**
     * Runs the Monitor (Semaphore) example with 5 worker threads.
